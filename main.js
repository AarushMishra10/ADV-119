...
document.getElementById('Label1').innerHTML = 'Sketch To be Drawn: ' + sketch;
...
if(drawn_sketch==sketch){
    answer_holder="set";
    score++;
    document.getElementById("score_90").innerHTML="Score:"+score;
}
    ...
    function gotResult(error,results){
        ...
        document.getElementById("Label1").innerHTML= "Your Sketch: "+drawn_sketch;
    ...
    function check_sketch(){
        ...
        timer_counter++;
        document.getElementById("tiime_90").innerHTML="Timer:"+timer_counter;
